...
class PricesStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetPrices = channel.unary_unary(
                '/Prices/GetPrices',
                request_serializer=coincide__pb2.PricesRequest.SerializeToString,
                response_deserializer=coincide__pb2.PricesResponse.FromString,
                )


class PricesServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_PricesServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetPrices': grpc.unary_unary_rpc_method_handler(
                    servicer.GetPrices,
                    request_deserializer=coincide__pb2.PricesRequest.FromString,
                    response_serializer=coincide__pb2.PricesResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'Prices', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
...
class Prices(object):
    ...
    def GetPrices(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Prices/GetPrices',
            coincide__pb2.PricesRequest.SerializeToString,
            coincide__pb2.PricesResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
